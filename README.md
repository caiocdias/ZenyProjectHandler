...
```powershell
.\.venv\Scripts\python.exe scripts\build_release.py --version 0.5.0
```

O comando recompõe `dist/release/0.5.0/`, gera os dois SBOMs, notas, manifesto e hashes e executa a
