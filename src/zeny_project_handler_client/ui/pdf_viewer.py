...
class PdfViewerWidget(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        layout.setSpacing(8)
        # Duas linhas de controles em docks estreitos, preservando espaço para o PDF.
        self.setMinimumWidth(360)
        toolbar = ResponsiveRowLayout()
        ...
        navigation.addWidget(open_button)
        ...
        zoom.addWidget(rotate_button)
        toolbar.addLayout(navigation)
        toolbar.addLayout(zoom)
