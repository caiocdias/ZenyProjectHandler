...
CATALOGO_FATOS_CONFORMIDADE = (
    ...
    _fact(
        ...
        TipoValorFato.TEXTO,
        _TEXTO,
        "Tecnologia catalogada do cabo de REDE_DISTRIBUICAO reconhecido na região.",
    ),
    _fact(
        ...
        TipoValorFato.TEXTO,
        _TEXTO,
        "Tecnologia catalogada de cada cabo de REDE_DISTRIBUICAO reconhecido como instalação.",
    ),
    _fact(
    ...
    _fact(
        ...
        TipoValorFato.TEXTO,
        _TEXTO,
        "Tipo topológico confirmado do trecho reconhecido na região.",
    ),
    _fact(
        "trecho.modalidade",
        _REGION,
        TipoValorFato.TEXTO,
        _TEXTO,
        "Modalidade física confirmada do trecho reconhecido na região.",
    ),
    _fact(
        "ramal.modalidade",
        _REGION,
        TipoValorFato.TEXTO,
        _TEXTO,
        "Modalidade física confirmada do ramal de conexão.",
    ),
    _fact(
        "ramal.comprimento_m",
        _REGION,
        TipoValorFato.NUMERO,
        _NUMERO,
        "Comprimento rastreável do ramal de conexão, em metros.",
    ),
    _fact(
        ...
        TipoValorFato.BOOLEANO,
        _BOOLEANO,
        "Indica modalidade aérea e comprimento resolvidos para o ramal de conexão.",
    ),
    _fact(
        "ramal.cabo_multiplex_confirmado",
        _REGION,
        TipoValorFato.BOOLEANO,
        _BOOLEANO,
        "Indica evidência positiva e rastreável de cabo multiplex no ramal aéreo.",
        available=False,
    ),
    _fact(
        "ramal.ancoragem_confirmada",
        _REGION,
        TipoValorFato.BOOLEANO,
        _BOOLEANO,
        "Indica evidência positiva e rastreável do sistema próprio de ancoragem do ramal aéreo.",
        available=False,
    ),
    _fact(
        "vao.comprimento_m",
        ...
        TipoValorFato.NUMERO,
        _NUMERO,
        "Comprimento rastreável do vão de REDE_DISTRIBUICAO, em metros.",
    ),
    _fact(
        ...
        TipoValorFato.BOOLEANO,
        _BOOLEANO,
        "Indica que a faixa excepcional de 45 m a 60 m da REDE_DISTRIBUICAO foi resolvida.",
    ),
    _fact(
        ...
        TipoValorFato.BOOLEANO,
        _BOOLEANO,
        "Indica demonstração positiva da exceção de vão da REDE_DISTRIBUICAO.",
    ),
)
...
def validar_semantica_registro(
    ...
    for rule in registro.regras:
        ...
        for group_name, conditions in (
            ...
            ("evaluate_when", rule.avaliabilidade),
